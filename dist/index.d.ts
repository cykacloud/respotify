...
declare class SpotifyDownloader {
    ...
    private readonly http;
    constructor(auth: SpotifyAuth, decryptorOrOptions?: SpotifyDecryptor | SpotifyDownloaderOptions);
